...
export default function Sidebar({ categoriesData }:{categoriesData:any}) {
  ...
  return (
    <>
    <aside className="hidden lg:flex flex-col w-64 px-4 py-8 overflow-y-auto border-r rtl:border-r-0 rtl:border-l  dark:border-gray-700">
    <div className="fixed w-[12.3rem] h-full">

    <div className='w-full text-center mb-6'>
    <Link href="/" className='font-[roboto] font-bold text-[2rem] tracking-[0.5rem]'>
    AMIRI
    </Link>
    </div>
